...
def train_by_OpenRLHF():
    cmd = f"""WANDB_API_KEY=75a0279c0374c55997f3d7736e7602a395d62da7 MKL_THREADING_LAYER=GNU DISABLE_VERSION_CHECK=1 deepspeed --module openrlhf.cli.train_prm --save_path ./prm_output/mistral-7b --save_steps 3000   --logging_steps 10    --eval_steps 300    --train_batch_size 32    --micro_train_batch_size 2    --pretrain mistralai/Mistral-7B-v0.1    --bf16    --max_epochs 1    --max_len 12800    --zero_stage 3    --learning_rate 1e-6   --dataset ./data/prm_data/prm_data.json    --input_key input    --label_key value    --flash_attn    --gradient_checkpointing    --packing_samples    --wandb_group prm    --placeholder_token ки    --reward_tokens + - --use_wandb 75a0279c0374c55997f3d7736e7602a395d62da7"""
