...
def prepare_data_for_llama_factory(args):
    ...
    with open(f"data/sft_data/sft_issue.json", 'w', encoding='utf-8') as f:
        json.dump(prompts, f, indent=4, ensure_ascii=False)
    return f"sft_data/sft_issue.json"
...
def main(args):
    ...
    eval.main_issue(args, model, proportion=0.4)
